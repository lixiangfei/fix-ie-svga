    ...
    global.SVGA = {
      ...
      createSWFObject: function(container, callback) {
        ...
        if (containerElement.getElementsByTagName("object").length === 0) {
          ...
          attributes.id = uuid;
          attributes.name = 'SVGAPlayerWeb';
          attributes.align = 'middle';

          swfobjectLib.embedSWF(
            SVGA.SWFLocation,
            containerElement.id,
        ...
        return {
          load: function(url, success, failure) {
            SVGA.createSWFObject(container, function(swfObject) {
              swfObject.SVGAParser_Instance_load(
                url,
                SVGA.createHandler(function(videoItem) {
                  success(videoItem);
                }),
      ...
      Player: function(container) {
        return {
          ...
          stepToFrame: function(frame, andPlay) {
            SVGA.createSWFObject(container, function(swfObject) {
              swfObject.SVGAPlayer_Instance_stepToFrame(
                frame,
                andPlay === true
              );
            });
          ...
          stepToPercentage: function(percentage, andPlay) {
            SVGA.createSWFObject(container, function(swfObject) {
              swfObject.SVGAPlayer_Instance_stepToPercentage(
                percentage,
                andPlay === true
              );
            });
          ...
          setText: function(textORMap, forKey) {
            SVGA.createSWFObject(container, function(swfObject) {
              if (typeof textORMap === "object") {
                swfObject.SVGAPlayer_Instance_setText(
                  textORMap.text,
                  textORMap.size,
                  textORMap.color,
                  forKey
          ...
          onFinished: function(callback) {
            SVGA.createSWFObject(container, function(swfObject) {
              swfObject.SVGAPlayer_Instance_onFinished(
                SVGA.createHandler(callback)
              );
            });
          },
          onFrame: function(callback) {
            SVGA.createSWFObject(container, function(swfObject) {
              swfObject.SVGAPlayer_Instance_onFrame(
                SVGA.createHandler(callback)
              );
            });
          },
          onPercentage: function(callback) {
            SVGA.createSWFObject(container, function(swfObject) {
              swfObject.SVGAPlayer_Instance_onPercentage(
                SVGA.createHandler(callback)
              );
            });
          },
          ...
          startAnimation: function() {
            SVGA.createSWFObject(container, function(swfObject) {
              swfObject.SVGAPlayer_Instance_setFrame(
                0,
                0,
                swfObject.offsetWidth,
